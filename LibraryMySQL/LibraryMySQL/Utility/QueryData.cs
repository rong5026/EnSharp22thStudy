...
namespace LibraryMySQL
{
    internal class QueryData
    {
        ...
        public const string SELECT_USER_BOOKLIST = "SELECT * FROM user_application_book"; // 유저가 신청한 책 리스트
        ...
        public const string INSERT_USER_APPLICATION_BOOK = "INSERT INTO user_application_book ( book_name, book_author, book_publisher, book_count, book_price, book_date, book_isbn, book_information ) VALUES ('{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}');";
        ...
        public const string DELETE_USER_APPLICATION_BOOK = "DELETE FROM user_application_book WHERE book_id = '{0}';";
