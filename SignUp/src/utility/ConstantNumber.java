...
public class ConstantNumber {
	...
	//guide 라벨 문구
	public final static String NAME_GUIDE ="한글,영어 10자리 범위내에서 입력해주세요.";
	...
	public final static String EMAIL_GUIDE ="영문자4~10+@+영문자2~8+.+ com 또는 net";
	
	public final static String PHONE_GUIDE ="ex)010-8791-4859";
